    ...
    <span className="inline-block ml-3 transition-transform ease-in-out group-hover:translate-x-2">
      <IconArrowRight />
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start mb-4">
          ...
          {/** About Section */}
          <div className="flex text-center flex-col lg:text-left lg:w-1/2 lg:pl-12">
            <h3 className="mb-4 text-3xl font-extrabold text-transparent title-font bg-gradient-to-r from-orange-600 to-orange-300 bg-clip-text">
              About
            </h3>
            <p className="text-base leading-relaxed text-[#6B7280]">
